            ...
            {featuredItems.map((item, index) => (
              ...
              >
                <Link href={`/menu/${item.category}/${item.id}`} className="block">
                  <div className="relative bg-white rounded-sm overflow-hidden shadow-[0_2px_8px_rgba(0,0,0,0.06)] hover:shadow-[0_12px_28px_rgba(0,0,0,0.12)] hover:-translate-y-1 transition-all duration-300 ease-out">
                    {/* Gold border on hover */}
                    ...
                    <div className="relative aspect-square overflow-hidden">
                      ...
                      {/* Popular badge */}
                      {item.isPopular && (
                        <div className="absolute top-2 right-2 px-2 py-1 bg-[#DA291C] text-white text-xs font-medium rounded-sm">
                          Popular
                        </div>
                      )}
                    </div>
                    ...
                    <div className="p-3 sm:p-4">
                      <h4 className="font-heading text-sm sm:text-base font-semibold text-[#1A1A1A] group-hover:text-[#DA291C] transition-colors duration-200 line-clamp-1">
                        {item.name.en}
                      </h4>
                      <p className="text-xs text-[#6B7280] mt-0.5 font-urdu">
                        {item.name.ur}
                      </p>
                    </div>
                  </div>
